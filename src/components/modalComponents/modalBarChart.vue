<template>
    <div class="modal-create-content">
        <div class="modal-header">
            <h5 class="modal-title">Opret bar chart</h5>
            ...
            <div class="mb-3">
                ...
                <div class="modal-checkpoint-container d-flex justify-content-around">
                    ...
                    <div class="right-container-data">
                        Vælg data
                        <div class="checkbox-container"><input type="checkbox" class="checkbox-size" v-model="selectedPoints.count"/>
...
const createChart = async () => {
    ...
    gridStackStore.addComponent("barChartComponent", result);
...
const canCreateChart = computed(() => {
    return (
        (selectedLabels.value.age ||
            selectedLabels.value.TrainingSessionsThisMonth) &&
        selectedPoints.value.count
    );
});
